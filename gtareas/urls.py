...
urlpatterns = [
    ...
    path('gtareas/<int:tarea_id>/ultimo-comentario/', views.ultimo_usuario_comentario, name='ultimo_usuario_comentario'),
    path('gtareas/comentarios/<str:palabra>/<int:anio>/', views.obtener_comentarios, name='obtener_comentarios'),
